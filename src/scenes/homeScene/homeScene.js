...
class App extends Component {
  ...
  readme() {
    Tts.getInitStatus().then(
      () => {
        let text =
          'или собі дід та баба. Вже й старі стали, а дітей нема. Журяться дід та баба: «Хто нашої й смерті догляне, що в нас дітей нема?» От баба й просить діда:\n' +
          '\n' +
